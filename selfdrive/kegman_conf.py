...
class kegman_conf():
  ...
  def read_config(self):
    ...
    if os.path.isfile('/data/kegman.json'):
      ...
      if self.config['battChargeMin'] != "85":
        self.config.update({"battChargeMin":"85"})
        self.config.update({"battChargeMax":"90"})
        self.element_updated = True
      ...
      self.config = {"cameraOffset":"0.06", "lastTrMode":"1", "battChargeMin":"85", "battChargeMax":"90", "wheelTouchSeconds":"180", "battPercOff":"25", "carVoltageMinEonShutdown":"12200", "brakeStoppingTarget":"0.25" }
      self.write_config(self.config)
    return self.config
